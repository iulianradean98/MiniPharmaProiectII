...
using MiniPharma.Helpers;
using MiniPharma.Services;
...
namespace MiniPharma.Views
{
    public sealed partial class LocalizareFarmaciiPage : Page, INotifyPropertyChanged
    {
